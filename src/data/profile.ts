export const profile = {
  ...
  socialLinks: [
    ...
    {
      label: "Medium",
      href: "https://medium.com/@vitaliystanyshevskyy",
    },
  ],
  highlights: [
    "Led remote and hybrid product teams of up to 10 engineers across payments, travel, and ecommerce.",
    "Shipped employee reimbursements to personal bank accounts at Pleo, supporting more than EUR 4.5M in monthly transfers.",
    "Introduced quality gates and better test coverage at Awaze, contributing to an approximately 40% reduction in production incidents.",
    "Reduced QA handover time at Awaze from up to one day to roughly 20 minutes by making the development environment independently testable.",
  ],
};
